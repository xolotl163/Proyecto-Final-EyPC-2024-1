...
Instructions.addElement( "binary", "not",  "001000")
Instructions.addElement( "binary", "xor",  "001001")
Instructions.addElement( "binary", "shl",  "001010")
Instructions.addElement( "binary", "shr",  "001011")
Instructions.addElement( "binary", "rol",  "001100")
Instructions.addElement( "binary", "ror",  "001101")
Instructions.addElement( "binary", "test", "001110")
Instructions.addElement( "binary", "mov",  "001111")
Instructions.addElement( "binary", "wrt",  "010000")
Instructions.addElement( "binary", "read", "010001")
Instructions.addElement( "binary", "call", "010010")
Instructions.addElement( "binary", "puAS", "010011")
Instructions.addElement( "binary", "popSF","010100")
Instructions.addElement( "binary", "popAS","010101")
Instructions.addElement( "binary", "jmp",  "010110")
Instructions.addElement( "binary", "je",   "010111")
Instructions.addElement( "binary", "jne",  "011000")
Instructions.addElement( "binary", "ja",   "011001")
Instructions.addElement( "binary", "jae",  "011010")
Instructions.addElement( "binary", "jb",   "011011")
Instructions.addElement( "binary", "jbe",  "011100")